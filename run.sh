...
port=8080
declare -a apps=("./build/bin/app-cpp" "./build/bin/app-go" "java -jar build/libs/httpbenchmark-1.0.0.jar")
declare -a nthreads=(2 4 8 16 32 64 128 256 512)

[ ! -d "./crow" ] && git clone https://github.com/ipkn/crow

echo "building c++"
g++ app.cpp -o build/bin/app-cpp -I./crow/include -pthread -lboost_system
echo "building go"
